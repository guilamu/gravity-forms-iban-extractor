...
class GF_IBAN_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gravity-forms-iban-extractor';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gravity-forms-iban-extractor/gravity-forms-iban-extractor.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gravity-forms-iban-extractor';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Gravity Forms IBAN Extractor';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Adds an IBAN extractor field type to Gravity Forms';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gravity-forms-iban-extractor';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gf_iban_github_release';
